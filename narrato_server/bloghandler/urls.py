...
from .views import BlogCreateView,UserBlogsView,BlogManageView,BlogListView,BlogSearchListView
...
urlpatterns = [
    ...
    path('blogs/search/', BlogSearchListView.as_view(), name='blog-list'),
